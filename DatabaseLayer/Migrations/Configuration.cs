namespace DatabaseLayer.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DatabaseLayer.Context.DatabaseContext>
    {
        ...
        protected override void Seed(DatabaseLayer.Context.DatabaseContext context)
        {
            ...
            {
                new ImageFileTypeModel{Type="SchoolImage"},
                new ImageFileTypeModel{Type="StudentImage"},
                new ImageFileTypeModel{Type="ParentImage"},
                new ImageFileTypeModel{Type="TeacherImage"},
                new ImageFileTypeModel{Type="BookImage"},
                new ImageFileTypeModel{Type="EventImage"},
                new ImageFileTypeModel{Type="AssessmentFile"},
                new ImageFileTypeModel{Type="HomeworkFile"},
                new ImageFileTypeModel{Type="AttendanceImage"},
                new ImageFileTypeModel{Type="OperationalStaffImage"},
                new ImageFileTypeModel{Type="NoImage"}
            };
            ...
            var images = new List<ImageFileUrlModel>
            {
                new ImageFileUrlModel()
                {
                                        ...
                                        ImageFileTypeId = context.ImageFileTypes.Where(x => x.Type == "NoImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                                        Url ="/Image/MyShool1.jpg",
                                        CreateDate =DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="SchoolImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                                        Url ="/Image/EnglishBook1.jpg",
                                        CreateDate =DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="BookImage").FirstOrDefault().ImageFileTypeId
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate =DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="TeacherImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate =DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="ParentImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate =DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="StudentImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate =DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="AssessmentFile").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate = DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="AttendanceImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                                        Url ="/image/St2_SickNote1.jpg",
                                        CreateDate = DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="AttendanceImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate = DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="HomeworkFile").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                ...
                new ImageFileUrlModel()
                {
                                        ...
                                        CreateDate = DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="EventImage").FirstOrDefault().ImageFileTypeId
                },
                //new ImageFileUrlModel()
                //{
                ...
                new ImageFileUrlModel()
                {
                                        Url ="/Image/MyStaff1.jpg",
                                        CreateDate = DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="OperationalStaffImage").FirstOrDefault().ImageFileTypeId
                },
                new ImageFileUrlModel()
                {
                                        Url ="/Image/MyStaff2.jpg",
                                        CreateDate = DateTime.Now,
                                        ImageFileTypeId = context.ImageFileTypes.Where(x=>x.Type=="OperationalStaffImage").FirstOrDefault().ImageFileTypeId
                }
            };
            ...
            var schools = new List<SchoolModel>
            {
                new SchoolModel
                {
                    ...
                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyShool1.jpg")).FirstOrDefault()
                }
            };
            ...
            {
                new SubjectModel{SubjectName="English"},
                new SubjectModel{SubjectName="Maths"},
                new SubjectModel{SubjectName="History"}
            };
            ...
            var books = new List<BookModel>
            {
                new BookModel{BookName="English Book 1",
                              ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/EnglishBook1.jpg")).FirstOrDefault(),
                              SubjectId = context.Subjects.Where(x=>x.SubjectName=="English").FirstOrDefault().SubjectId
                },
                new BookModel{BookName="Maths Book 1",
                              ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MathsBook1.jpg")).FirstOrDefault(),
                              SubjectId = context.Subjects.Where(x=>x.SubjectName=="Maths").FirstOrDefault().SubjectId
                },
                new BookModel{BookName="History Book 1",
                              ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/HistoryBook1.jpg")).FirstOrDefault(),
            ...
            var teachers = new List<TeacherModel>
            {
                new TeacherModel{TeacherName="My Teacher 1",Tr_Address1="Teacher1 street", Tr_Address2="Teacher1 Town",Tr_PostCode="TR10TY",Tr_Email="myTeacher1@school.com",Tr_Telephone="032423432",
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyTeacher1.jpg")).FirstOrDefault(),
                ...
                new TeacherModel{TeacherName="My Teacher 2",Tr_Address1="Teacher2 street", Tr_Address2="Teacher2 Town",Tr_PostCode="TR02TY",Tr_Email="myTeacher2@school.com",Tr_Telephone="032432423",
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyTeacher2.jpg")).FirstOrDefault(),
            ...
            //Add dummy OperationalStaff
            var staffs = new List<OperationalStaffModel>
            {
                new OperationalStaffModel
                {
                                 OpStaffName ="My Staff 1",OpStaffAddress1="Staff1 street", OpStaffAddress2="Staff1 Town",OpStaffPostCode="SF10TY",
                                 OpStaffEmail ="myStaff1@school.com",OpStaffTelephone="032423232",OpStaffRole = "Admin",
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyStaff1.jpg")).FirstOrDefault(),
                                 SchoolId = context.Schools.Where(x=>x.SchoolName=="My School 1").FirstOrDefault().SchoolId
                },
                new OperationalStaffModel
                {
                                 OpStaffName ="My Staff 2",OpStaffAddress1="Staff2 street", OpStaffAddress2="Staff2 Town",OpStaffPostCode="SF20TY",
                                 OpStaffEmail ="myStaff2@school.com",OpStaffTelephone="032423232",OpStaffRole = "Admin",
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyStaff2.jpg")).FirstOrDefault(),
                                 SchoolId = context.Schools.Where(x=>x.SchoolName=="My School 1").FirstOrDefault().SchoolId
                }
            };
            context.OperationalStaffs.AddRange(staffs);
            context.SaveChanges();
            ...
            {
                new ParentModel
                {               ParentName="My Parent 1",RelationType="Father", ParentAddress1="Parent1 street",ParentAddress2="Parent1 Town",
                                ParentPostCode ="PT01PSY",ParentTelephone="0324234431",ParentEmail="myparent1@school.com",
                                ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyParent1.jpg")).FirstOrDefault()
                },
                new ParentModel
                {
                                ParentName ="My Parent 2",RelationType="Mother", ParentAddress1="Parent2 street",ParentAddress2="Parent2 Town",
                                ParentPostCode ="PT02PSY",ParentTelephone="0324234439",ParentEmail="myparent2@school.com",
                                ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyParent2.jpg")).FirstOrDefault()
                }
            };
            ...
            var students = new List<StudentModel>
            {
                new StudentModel{St_Name="My Student 1",EnrolmentDate=DateTime.Now, St_Address1="Student1 street",St_Address2="Student1 Town",St_PostCode="ST01SY",St_Telephone="0324234432",St_Email="mystudent1@school.com",
                                 ...
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyStudent1.jpg")).FirstOrDefault(),
                ...
                new StudentModel{St_Name="My Student 2",EnrolmentDate=DateTime.Now, St_Address1="Student2 street",St_Address2="Student2 Town",St_PostCode="ST02SY",St_Telephone="0324234433",St_Email="mystudent2@school.com",
                                 ...
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyStudent2.jpg")).FirstOrDefault(),
                ...
                new StudentModel{St_Name="My Student 3",EnrolmentDate=DateTime.Now, St_Address1="Student3 street",St_Address2="Student3 Town",St_PostCode="ST03SY",St_Telephone="0324234434",St_Email="mystudent3@school.com",
                                 StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 1").FirstOrDefault().StandardId,
                                 ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/MyStudent3.jpg")).FirstOrDefault(),
            ...
            {
                new AssessmentModel{AssessmentName="Assessment 1",AssessmentDate=DateTime.Now,
                                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/File/Assessment1.doc")).FirstOrDefault(),
                                    StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 1").FirstOrDefault().StandardId
                },
                new AssessmentModel{AssessmentName="Assessment 2",AssessmentDate=DateTime.Now,
                                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/File/Assessment2.doc")).FirstOrDefault(),
                                    StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 2").FirstOrDefault().StandardId
                },
                new AssessmentModel{AssessmentName="Assessment 3",AssessmentDate=DateTime.Now,
                                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/File/Assessment3.doc")).FirstOrDefault(),
                                    StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 1").FirstOrDefault().StandardId
                }
            };
            ...
            var attendances = new List<AttendanceModel>
            {
                new AttendanceModel{
                                    ...
                                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/image/St1_SickNote1.jpg")).FirstOrDefault()
                },
                new AttendanceModel{
                                    AttendanceDate =DateTime.Now,
                                    Present = true,
                                    StudentId = context.Students.Where(x=>x.St_Name=="My Student 2").FirstOrDefault().StudentId,
                                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/image/St2_SickNote1.jpg")).FirstOrDefault()
                },
                new AttendanceModel{
                                    AttendanceDate =DateTime.Now,
                                    Present = false,
                                    StudentId = context.Students.Where(x=>x.St_Name=="My Student 3").FirstOrDefault().StudentId,
                                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/image/St3_SickNote1.jpg")).FirstOrDefault()
                }
            };
            ...
            {
                new HomeworkModel{HomeworkName="Homework 1",IssueDate=DateTime.Now,DueDate=null,
                                  StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 1").FirstOrDefault().StandardId,
                                  ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/File/Homework1.doc")).FirstOrDefault()
                },
                new HomeworkModel{HomeworkName="Homework 2",IssueDate=DateTime.Now,DueDate=null,
                                  StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 2").FirstOrDefault().StandardId,
                                  ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/File/Homework2.doc")).FirstOrDefault()
                },
                new HomeworkModel{HomeworkName="Homework 3",IssueDate=DateTime.Now,DueDate=null,
                                  StandardId = context.Standards.Where(x=>x.StandardName=="My Standard 1").FirstOrDefault().StandardId,
                                  ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/File/Homework3.doc")).FirstOrDefault()
                }
            };
            ...
            {
                new EventModel{EventName="Event 1",EventDate=DateTime.Now,Location="SC029YU",
                    //ImageFileUrls = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/Event1_Image1.Jpg") || x.Url.Contains("/Image/Event1_Image2.Jpg")).ToList(),
                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/Event1_Image1.Jpg")).FirstOrDefault(),
                    Students = context.Students.Where(x=>x.St_Name=="My Student 1" || x.St_Name=="My Student 2").ToList()
                },
                new EventModel{EventName="Event 2",EventDate=DateTime.Now,Location="SC029YU",
                    //ImageFileUrls = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/Event2_Image1.Jpg") || x.Url.Contains("/Image/Event2_Image2.Jpg")).ToList(),
                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/Event2_Image1.Jpg")).FirstOrDefault(),
                    Students = context.Students.Where(x=>x.St_Name=="My Student 1" || x.St_Name=="My Student 3").ToList()
                },
                new EventModel{EventName="Event 3",EventDate=DateTime.Now,Location="SC029YU",
                    //ImageFileUrls = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/Event3_Image1.Jpg") || x.Url.Contains("/Image/Event3_Image2.Jpg")).ToList(),
                    ImageFileUrl = context.ImageFileUrls.Where(x=>x.Url.Contains("/Image/Event3_Image1.Jpg")).FirstOrDefault(),
            ...
            {
                new BookTransactionModel{IssueDate=DateTime.Now,ReturnDate=null,
                                         BookId = context.Books.Where(x=>x.BookName=="English Book 1").FirstOrDefault().BookId,
                                         StudentId = context.Students.Where(x=>x.St_Name=="My Student 1").FirstOrDefault().StudentId
                },
                new BookTransactionModel{IssueDate=DateTime.Now,ReturnDate=null,
                                         BookId = context.Books.Where(x=>x.BookName=="Maths Book 1").FirstOrDefault().BookId,
                                         StudentId = context.Students.Where(x=>x.St_Name=="My Student 2").FirstOrDefault().StudentId
                },
                new BookTransactionModel{IssueDate=DateTime.Now,ReturnDate=null,
                                         BookId = context.Books.Where(x=>x.BookName=="History Book 1").FirstOrDefault().BookId,
                                         StudentId = context.Students.Where(x=>x.St_Name=="My Student 3").FirstOrDefault().StudentId
                }
            };
